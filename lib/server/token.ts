// SOLO SERVER. Non importare mai questo file da un componente 'use client' o
// da qualunque pagina che finisce nel bundle inviato al browser: contiene la
// logica di firma che deve restare privata.
//
...
type Payload = {
  ...
  tier: Tier; // piano acquistato, ricavato dal price id Stripe
